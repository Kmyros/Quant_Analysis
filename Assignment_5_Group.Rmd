...
Therefore, we tested the same regression model but used a means centering transformation. The means centered regression model has a median sales price of $284,302 based on the average sized inventory. 
