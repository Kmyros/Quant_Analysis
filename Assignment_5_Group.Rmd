...
coeff_names <- c("Constant" = "(Intercept)",
                 "Median Sales Price" = "SaleP_Sep", 
                 "Highly Mortgage Burdened" = "MortBurd_Quality",
                 "Low Median Household Income" = "MedIncome_Quality")
...
The initial model had a y-intercept of $266,812, meaning that if no homes were listed for sale, (inventory equals zero) than the median sales price would be $266,812. However, an inventory of zero would mean that there is no activity in the housing market, therefore there cannot be a median sales price because no sales are occurring. 

Therefore, we tested the same regression model but used a means centering transformation. The means centered regression model has a median sales price of $284,302 based on the average sized inventory. The average housing inventory size is 8,336 homes.  

As expected, the R value, relationship fit and coefficient values do not change as only the data has been transformed to have a more meaningful interpretation. 
