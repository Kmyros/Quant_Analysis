...
We joined our dataset based on the re-coded MSA variables. 
...
https://c-voulgaris.github.io/GSD_SES_5215_F2021/A6_Example.html#Bivariate_regression



```{r}
effect_plot(full_model, pred = SaleP_Sep, interval = TRUE) +
  scale_y_continuous(name = "Inventory Size for MSAs /n by Socioeconomic determinants") +
  scale_x_continuous(name = "Median Sale Price")
